...
#    Jan 23, 2020 01:38:42 PM PST  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Data_entry.place(relx=0.109, rely=0.274,height=26, relwidth=0.127)
        ...
        self.Initialization_ent = ttk.Combobox(self.Frame1)
        ...
        self.Normalization_ent = ttk.Combobox(self.Frame1)
        ...
        self.Text1.place(relx=0.042, rely=0.588, relheight=0.298, relwidth=0.221)
        ...
        self.Training.configure(cursor="fleur")
        ...
        self.Comp_Name_ent = ttk.Combobox(self.Frame1)
